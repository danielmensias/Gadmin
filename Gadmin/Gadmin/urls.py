...
from apps.eventos.views import ResumenDatos
...
urlpatterns = [
    ...
    url(r'^home/$',ResumenDatos, name='home'),
    url(r'^admin/', admin.site.urls),
    url(r'^animales/', include('apps.animales.urls', namespace="animal")),
